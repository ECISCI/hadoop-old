...
public class FileOperation {
     ...
     *
     * 5.15. %s/it521/xiaoming 在底行命名模式下 将文件中所有的替换成 xiaoming
     *
     ...
     */
    /*
     * 6.1.将 it521.text移动到mingHadoop文件夹下并将ming.text的文件名更改为 mingHadoop.text
     *
     * mv it521.text mingHadoop/mingHadoop.text
     */

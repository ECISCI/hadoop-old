package com.it521.website.mr.pageviews;

import com.it521.website.mr.WebLogBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		...
		FileInputFormat.setInputPaths(job, new Path("H:\\output"));
		FileOutputFormat.setOutputPath(job, new Path("H:\\pageviews"));

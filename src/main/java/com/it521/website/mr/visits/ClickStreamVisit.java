package com.it521.website.mr.visits;

import com.it521.website.mr.pageviews.PageViewsBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		FileInputFormat.setInputPaths(job, new Path("H:\\pageviews"));
		FileOutputFormat.setOutputPath(job, new Path("H:\\visitout"));

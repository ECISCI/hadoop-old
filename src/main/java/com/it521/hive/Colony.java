...
public class Colony {
    ...
    /* 主机名            ip            所需软件                    运行进程
     *
     * hadoop01  192.168.25.136      jdk,it521         namenode,DFSZKFailoverController(zkfc)
     *
     * hadoop02  192.168.25.133      jdk,it521         namenode,DFSZKFailoverController(zkfc)
     *
     * hadoop03  192.168.25.134      jdk,it521         ResourceManager
     *
     * hadoop04  192.168.25.135      jdk,it521         ResourceManager
     *
     * hadoop05  192.168.25.137      jdk,it521,zk      DataNode、NodeManager、JournalNode、QuorumPeerMain
     *
     * hadoop06  192.168.25.138      jdk,it521,zk      DataNode、NodeManager、JournalNode、QuorumPeerMain
     *
     * hadoop07  192.168.25.139      jdk,it521,zk      DataNode、NodeManager、JournalNode、QuorumPeerMain
     *
     */
     ...
     *
     *5. 进入cd /usr/local/apps/it521-2.6.4/etc/it521/
     *
     *6. 需要编辑的文件有 <it521-env.sh core-site.xml hdfs-site.xml mapred-site.xml yarn-site.xml salves>
     *
     *   6.1 it521-env.sh 配置本机Java环境 如下所示
     ...
     *
     *
     *9. 执行命令 scp -r it521-2.6.4/ hadoop02:/usr/local/apps
     *
     ...
     *
     * 执行命令 ./it521-daemon.sh start journalnode (用jps查看进程,看看是否启动成功,一旦启动失败,全玩完)
     *
     ...
     *
     *6. 进入hadoop01 it521-2.6.4/sbin目录下 执行命令 ./start-dfs.sh
     *

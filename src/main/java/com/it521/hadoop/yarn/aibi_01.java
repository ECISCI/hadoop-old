...
public class aibi_01 {
    ...
    /**
     * @1.yarn的组成部分 ResourceManager NodeManager JobHistoryServer Containers ApplicationMaster job task client 8部分组成
     */
     ...
     */
    /*
     *  job    一个Mapper 一个Reducer 或一个进程的输入列表,job也可以叫做Application
     *
    ...
    /**
     * @2.Yarn上运行应用程序 主要分为两类  1.短应用程序 2.长应用程序
     */

...
public class Aibi {
     ...
     * sbin/it521-daemon.sh start datanode
     ...
     * 2013-09-22 17:27:26,423 INFO org.apache.it521.net.NetworkTopology: Adding a new node:  /default-rack/ 192.168.147.92:50010
     * 每个IP 对应的机架ID都是 /default-rack ，说明hadoop的机架感知没有被启用。
     * 要将hadoop机架感知的功能启用，配置非常简单，在 NameNode所在节点的/home/bigdata/apps/it521/etc/hadoop的core-site.xml配置文件中配置一个选项:
     * <property>
     *   <name>topology.script.file.name</name>
     *   <value>/home/bigdata/apps/it521/etc/it521/topology.sh</value>
     * </property>
     ...
     * #!/bin/bash
     * HADOOP_CONF=/home/bigdata/apps/it521/etc/it521
     * while [ $# -gt 0 ] ; do
     *   nodeArg=$1
     ...
     * 2013-09-23 17:16:27,272 INFO org.apache.it521.net.NetworkTopology: Adding a new node:  /dc1/rack3/  192.168.147.94:50010
     * 说明hadoop的机架感知已经被启用了。
     * 查看HADOOP机架信息命令:
     * ./it521 dfsadmin -printTopology
     * Rack: /dc1/rack1
     ...
     *
     *  假设Hadoop集群在192.168.147.68上部署了NameNode和DataNode,启用了机架感知，执行bin/it521 dfsadmin -printTopology看到的结果：
     * Rack: /dc1/rack1
     ...
     * 然后，sbin/it521-daemons.sh start datanode启动数据节点dbj69,任意节点执行bin/it521 dfsadmin -printTopology 看到的结果：
     * Rack: /dc1/rack1
     *    192.168.147.68:50010 (dbj68)
     *
     * Rack: /dc1/rack2
     ...
     * 注意：如果不将dbj69的配置加入到topology.data中，执行sbin/it521-daemons.sh start datanode启动数据节点dbj69，datanode日志中会有异常发生，导致dbj69启动不成功。
     * 2013-11-21 10:51:33,502 FATAL org.apache.it521.hdfs.server.datanode.DataNode: Initialization failed for block pool Block pool BP-1732631201-192.168.147.68-1385000665316 (storage id DS-878525145-192.168.147.69-50010-1385002292231) service to dbj68/192.168.147.68:9000
     * org.apache.it521.ipc.RemoteException(org.apache.it521.net.NetworkTopology$InvalidTopologyException): Invalid network topology. You cannot have a rack and a non-rack node at the same level of the network topology.
     *   at org.apache.it521.net.NetworkTopology.add(NetworkTopology.java:382)
     *   at org.apache.it521.hdfs.server.blockmanagement.DatanodeManager.registerDatanode(DatanodeManager.java:746)
     *   at org.apache.it521.hdfs.server.namenode.FSNamesystem.registerDatanode(FSNamesystem.java:3498)
     *   at org.apache.it521.hdfs.server.namenode.NameNodeRpcServer.registerDatanode(NameNodeRpcServer.java:876)
     *   at org.apache.it521.hdfs.protocolPB.DatanodeProtocolServerSideTranslatorPB.registerDatanode(DatanodeProtocolServerSideTranslatorPB.java:91)
     *   at org.apache.it521.hdfs.protocol.proto.DatanodeProtocolProtos$DatanodeProtocolService$2.callBlockingMethod(DatanodeProtocolProtos.java:20018)
     *   at org.apache.it521.ipc.ProtobufRpcEngine$Server$ProtoBufRpcInvoker.call(ProtobufRpcEngine.java:453)
     *   at org.apache.it521.ipc.RPC$Server.call(RPC.java:1002)
     *   at org.apache.it521.ipc.Server$Handler$1.run(Server.java:1701)
     *   at org.apache.it521.ipc.Server$Handler$1.run(Server.java:1697)
     *   at java.security.AccessController.doPrivileged(Native Method)
     *   at javax.security.auth.Subject.doAs(Subject.java:415)
     *   at org.apache.it521.security.UserGroupInformation.doAs(UserGroupInformation.java:1408)
     *   at org.apache.it521.ipc.Server$Handler.run(Server.java:1695)
     *
     *   at org.apache.it521.ipc.Client.call(Client.java:1231)
     *   at org.apache.it521.ipc.ProtobufRpcEngine$Invoker.invoke(ProtobufRpcEngine.java:202)
     *   at $Proxy10.registerDatanode(Unknown Source)
     *   at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
     *   at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:57)
     *   at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
     *   at java.lang.reflect.Method.invoke(Method.java:601)
     *   at org.apache.it521.io.retry.RetryInvocationHandler.invokeMethod(RetryInvocationHandler.java:164)
     *   at org.apache.it521.io.retry.RetryInvocationHandler.invoke(RetryInvocationHandler.java:83)
     *   at $Proxy10.registerDatanode(Unknown Source)
     *   at org.apache.it521.hdfs.protocolPB.DatanodeProtocolClientSideTranslatorPB.registerDatanode(DatanodeProtocolClientSideTranslatorPB.java:149)
     *   at org.apache.it521.hdfs.server.datanode.BPServiceActor.register(BPServiceActor.java:619)

package com.it521.hadoop.basic.install;
...
public class 编译安装 {
     ...
     */
    /*
     * 命令 tar -zxvf it521-2.4.0-src.tar.gz
     */
     ...
     * @6集群配置
     */
    /*@1 配置文件修改 路径(/usr/local/it521/it521-2.6.4/etc/it521)
     *
     *1.1 首先找到JAVA_HOME路径
     *
     *命令 echo $JAVA_HOME (得到JAVA_HOME路径)
     *
     *1.2 vim it521-env.sh 修改JAVA_HOME
     *
     ...
     *
     *1.4 将hadoop加入到环境变量中 export HADOOP_HOME=/usr/local/it521/it521-2.6.4(参照etc-profile)
     *
     *1.5 格式化 it521
     *
     ...
     *
     *格式化过程中出现  Storage directory /home/it521/it521-2.4.1/tmp/dfs/has been successfully formatted
     *
     *证明格式化成功
     *
     *1.6 启动hadoop 进入hadoop目录下的sbin目录(若简单启动namenode可以使用命令./it521-daemon.sh start namenode )
     *
     ...
     *starting datanode, logging to /usr/local/it521/it521-2.6.4/logs/it521-root-datanode-hadoop04.out
     *
     * 进入  /usr/local/it521/it521-2.6.4/logs/
     *
